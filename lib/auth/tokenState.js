...
const DEFAULT_TOKEN_EXPIRATION_TIME_HOURS = 8
...
module.exports = function (app, config) {
  ...
  const tokensCollectionName = config.auth.tokensCollection || 'tokens'
  const tokenExpirationTimeHours = config.auth.tokenExpirationTimeHours || DEFAULT_TOKEN_EXPIRATION_TIME_HOURS
